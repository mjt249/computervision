...
parser.add_argument('--validate_every', type=int, default=2500,
    help='Run validation test and print out statistics every this many iterations.')
...
def vgg_16(data, labels=None, train=False, param=learned_param,
                num_classes=100, with_labels=True):
    """
    Returns a protobuf text file specifying a variant of VGG
        - The Fully Connected (FC) layers (fc6 and fc7) have smaller dimensions
    ...
    conv_kwargs = dict(param=param, train=train)
    n.conv1_1, n.relu1_1 = conv_relu(n.data, 3, 64, stride=1, pad=1, **conv_kwargs)
    n.conv1_2, n.relu1_2 = conv_relu(n.relu1_1, 3, 64, stride=1, pad=1, **conv_kwargs)
    n.pool1 = max_pool(n.relu1_2, 2, stride=2, train=train)

    n.conv2_1, n.relu2_1 = conv_relu(n.pool1, 3, 128, stride=1, pad=1, **conv_kwargs)
    n.conv2_2, n.relu2_2 = conv_relu(n.relu2_1, 3, 128, stride=1, pad=1, **conv_kwargs)
    n.pool2 = max_pool(n.relu2_2, 2, stride=2, train=train)

    n.conv3_1, n.relu3_1 = conv_relu(n.pool2, 3, 256, stride=1, pad=1, **conv_kwargs)
    n.conv3_2, n.relu3_2 = conv_relu(n.relu3_1, 3, 256, stride=1, pad=1, **conv_kwargs)
    n.conv3_3, n.relu3_3 = conv_relu(n.relu3_2, 3, 256, stride=1, pad=1, **conv_kwargs)
    n.pool3 = max_pool(n.relu3_3, 2, stride=2, train=train)

    n.conv4_1, n.relu4_1 = conv_relu(n.pool3, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.conv4_2, n.relu4_2 = conv_relu(n.relu4_1, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.conv4_3, n.relu4_3 = conv_relu(n.relu4_2, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.pool4 = max_pool(n.relu4_3, 2, stride=2, train=train)

    n.conv5_1, n.relu5_1 = conv_relu(n.pool4, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.conv5_2, n.relu5_2 = conv_relu(n.relu5_1, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.conv5_3, n.relu5_3 = conv_relu(n.relu5_2, 3, 512, stride=1, pad=1, **conv_kwargs)
...
def vgg_like(data, labels=None, train=False, param=learned_param,
                num_classes=100, with_labels=True):
    """
    Returns a protobuf text file specifying a variant of VGG
        - The Fully Connected (FC) layers (fc6 and fc7) have smaller dimensions
    ...
    n.conv3_2, n.relu3_2 = conv_relu(n.relu3_1, 3, 256, stride=1, pad=1, **conv_kwargs)
    n.conv3_3, n.relu3_3 = conv_relu(n.relu3_2, 3, 256, stride=1, pad=1, **conv_kwargs)
    n.conv3_4, n.relu3_4 = conv_relu(n.relu3_3, 3, 256, stride=1, pad=1, **conv_kwargs)
    n.pool3 = max_pool(n.relu3_4, 2, stride=2, train=train)

    n.conv4_1, n.relu4_1 = conv_relu(n.pool3, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.conv4_2, n.relu4_2 = conv_relu(n.relu4_1, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.conv4_3, n.relu4_3 = conv_relu(n.relu4_2, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.conv4_4, n.relu4_4 = conv_relu(n.relu4_3, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.pool4 = max_pool(n.relu4_4, 2, stride=2, train=train)

    n.conv5_1, n.relu5_1 = conv_relu(n.pool4, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.conv5_2, n.relu5_2 = conv_relu(n.relu5_1, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.conv5_3, n.relu5_3 = conv_relu(n.relu5_2, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.conv5_4, n.relu5_4 = conv_relu(n.relu5_3, 3, 512, stride=1, pad=1, **conv_kwargs)
    n.pool5 = max_pool(n.relu5_4, 2, stride=2, train=train)
...
def train_net(with_val_net=False):
    ...
    # list of (iter, [train accuracy], [validation accuracy])
    accuracies = []
    ...
    for iteration in xrange(args.iters):
        ...
        if (args.disp > 0) and (iteration % args.disp == 0):
            ...
            # print accuracy every args.validate_every iterations to test
            if iteration != 0 and iteration % args.validate_every == 0:

                solver.net.forward()
                disp_outputs(args.iters)
                solver.net.save(snapshot_at_iteration(iteration))

                print "============================================="
                print '\nPerforming evaluation step. Evaluating...\n'

                train_accuracy = eval_net('train', iteration=iteration)
                val_accuracy = eval_net('val', iteration=iteration)
                eval_net('test', iteration=iteration)
                accuracies.append((iteration, train_accuracy, val_accuracy))

                print 
                print "_______Accuracy chart up to now:______"
...
def eval_net(split, K=5, iteration=args.iters):
    ...
    weights_file = snapshot_at_iteration(iteration)
    ...
    filename = 'top_%d_predictions_%d.%s.csv' % (K, iteration, split)
